...
function PlayState:enter(params)
    ...
    if self.level <= 11 then
        self.scoreGoal = self.level * 1000
    elseif self.level == 12 then
        self.scoreGoal =  actual_level*level_12
...
function PlayState:render()
    ...
    if self.highlightedTile then
        ...
        love.graphics.setColor(35/255, 128/255, 30/255, 56)
    ...
    if self.rectHighlighted then
        love.graphics.setColor(217/255, 87/255, 99/255, 255)
    else
        love.graphics.setColor(172/255, 50/255, 50/255, 255)
    end
    ...
    love.graphics.setColor(0, 155/255, 255/255, 255/365)
