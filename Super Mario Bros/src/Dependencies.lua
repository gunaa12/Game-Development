...
gSounds = {
    ...
    ['death'] = love.audio.newSource('sounds/death.wav', 'stream'),
    ['music'] = love.audio.newSource('sounds/music.wav', 'stream'),
    ['powerup-reveal'] = love.audio.newSource('sounds/powerup-reveal.wav', 'stream'),
    ['pickup'] = love.audio.newSource('sounds/pickup.wav', 'stream'),
    ['empty-block'] = love.audio.newSource('sounds/empty-block.wav', 'stream'),
    ['kill'] = love.audio.newSource('sounds/kill.wav', 'stream'),
    ['kill2'] = love.audio.newSource('sounds/kill2.wav', 'stream')
}
...
gTextures = {
    ...
    ['lock'] = love.graphics.newImage('graphics/lock.png'),
